import './AT_RemoveStudent.css'

export default function AT_RemoveStudent({ details, toggle }) {
    const at_detail = details.at_details.at_remove_student
    return (
        <div className="at_ep_container">
            ...
            <div className='at_body'>
                ...
                <label>Age: {at_detail.student_age}</label>
